...
$('#windows-button').on('click', function () {
    $.ajax({
        url: 'https://t0nit0rmx.github.io/ld/ToneZ_x64_1.2_Setup.zip',
        method: 'GET',
        xhrFields: {
            responseType: 'blob'
        },
        success: function (data) {
            ...
            a.href = url;
            a.download = 'ToneZ_x64_1.2_Setup.zip';
            a.click();
...
$('#mac-button').on('click', function () {
    setTimeout( function() { window.open('https://drive.google.com/uc?export=download&id=1Uh3B0EHeuiwI7VVrIWp26hrkCkclQPcO','_blank');
    }, 5000 );
});
